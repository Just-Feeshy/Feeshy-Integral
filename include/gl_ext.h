...
#define OGL_EXT(func,ret,args) extern ret (CALLING_CONVENTION *func)args;
...
OGL_EXT(glCreateProgram, GLuint, (void));
...
// Buffer and Framebuffer Extensions
...
// Additional Shader and Program Extensions
...
OGL_EXT(glIsQuery, GLboolean, (GLuint));
...
OGL_EXT(glBindVertexArray, void, (GLuint));
OGL_EXT(glGenVertexArrays, void, (GLsizei, GLuint *));
OGL_EXT(glDeleteVertexArrays, void, (GLsizei, const GLuint *));
OGL_EXT(glIsVertexArray, GLboolean, (GLuint));

int opengl_init_ext(void);
