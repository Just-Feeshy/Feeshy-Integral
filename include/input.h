...
// For SDL3 (If I could rewrite this, I would use a 'macro helper' for this)
...
// Uh oh, likely I have to increase this
...
typedef enum input_status : uint8_t {
    PRESS_DOWN = 0,
    PRESS_UP = 1,
    PRESS_HOLD = 2
} input_status;

typedef void (*InputCallback)(uint64_t control_status, input_status input);
...
typedef struct inputs {
    uint16_t mapped_inputs[INPUT_W - INPUT_A + 1];
